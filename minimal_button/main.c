...
/* GPIOC Register */
#define GPIOC_BASE      	(PERIPH_BASE + 0x00020800)
#define GPIOC_MODER     	(*(volatile uint32_t*)(GPIOC_BASE + 0x00000000))
#define GPIOC_PUPDR     	(*(volatile uint32_t*)(GPIOC_BASE + 0x0000000C))
#define GPIOC_IDR		(*(volatile uint32_t*)(GPIOC_BASE + 0x00000010))

#define GPIO_MODER_MODER5_0	(1 << 10)

#define GPIO_PUPDR_PUPDR13_0   	(1 << 26)                                                                   

#define GPIO_IDR_IDR13		(1 << 13)
